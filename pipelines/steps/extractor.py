...
import re
from pipelines.steps.classifier import classify_ask_type
from pipelines.steps.classifier import classify_spell_text
    ...
    for p in document.paragraphs:
        ...
        if(inside_section == True):
            if text.startswith("Sequence"):
                ...
                norm = phrase.strip().lstrip('"').lstrip("'").rstrip('"').rstrip("'")
                spell_type = classify_spell_text(norm)
                current_sequence["spell type"] = spell_type
