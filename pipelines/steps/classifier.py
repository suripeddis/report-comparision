        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "── DIMENSION 1: METHOD ──\n"
                    "Classify each prompt as belonging to one of three AAC methodologies:\n\n"
                    ...
                    "Spellers (Spellers Method) — prompts rooted in a motor-execution framework whose "
                    "guiding principle is 'prompt the motor, not the answer.' Characteristic markers: cues "
                    "supporting the physical mechanics of pointing — starting a movement, hand/finger "
                    "gestures to orient toward the board, directional path cues, eye/visual-attention cues "
                    "(treated as a fine-motor skill), and pacing/continuation cues — without addressing the "
                    "content of the answer or the student's emotional state.\n"
                    "Examples: 'Ready, set, go.' / 'First letter is...' / 'Look for your letter.' / "
                    "'Eyes on the board.' / 'Keep going.'\n\n"
                    "Decision rule (method): content/academic engagement → RPM. For motor prompts, choose "
                    "between S2C and Spellers — use SPELLERS when the cue is pure motor execution fitting one "
                    "of the five Spellers types (initiation, gestural, directional, eye, continuation); use "
                    "S2C when the prompt involves body regulation (breathing, calming, stillness) or general "
                    "Spelling-to-Communicate letterboard navigation. If a prompt mixes motor and content, "
                    ...
                    "If method = spellers, pick exactly one of these six Spellers types:\n"
                    "  initiation — Cue to START a movement sequence (getting started is often the hardest "
                    "part for apraxia). Examples: 'Ready, set, go.' / 'First letter is...'\n"
                    "  gestural — Hand or finger gesture supporting visual orientation/targeting toward the "
                    "board (a physical gesture, not a verbal cue). Example: facilitator gestures toward an "
                    "area of the board.\n"
                    "  directional — Verbal cue guiding the movement PATH ('up', 'down', 'one over', "
                    "'next door'). Highest dependency risk.\n"
                    "  eye — Cue to keep visual attention on the board ('Look for your letter.' / 'Eyes on "
                    "the board.'); treated as a fine-motor support.\n"
                    "  continuation — Keeps the body moving AFTER initiation; supports pacing, rhythm, and "
                    "endurance. Examples: 'Keep going.' / 'Next.'\n"
                    "  none — Not really a prompt (acknowledgement, narration, off-task). Use when no other "
                    "Spellers type fits.\n\n"
                    ...
                    "- Spellers, eye/visual-attention cue ('look for your letter', 'eyes on the board') → eye\n"
                    "- Spellers, hand/finger gesture toward the board → gestural\n"
                    "- Spellers, path words (up/down/over/next door) → directional\n"
                    "- Spellers, cue to begin a movement → initiation\n"
                    "- Spellers, 'keep going' style pacing cue → continuation\n\n"
                    ...
                    "- method — one of: s2c, rpm, spellers\n"
                    ...
                    "    if method=spellers → one of: initiation, gestural, directional, eye, "
                    "continuation, none\n"
